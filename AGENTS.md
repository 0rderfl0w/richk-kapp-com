...
Uses git worktree (NEVER checkout deploy branch in project dir):

```bash
# 1. Build on main
bun run build

# 2. Deploy via worktree
...
- `frontend` — Astro pages, React islands, Tailwind
- `designer` — Visual design, color theory, spacing
